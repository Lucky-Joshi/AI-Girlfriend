...
-- Grants for Data API access with publishable / anon keys
...
-- Policies (adjust these if you later add per-user auth)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1
...
-- Ask PostgREST to refresh its schema cache after applying this file
